...
def main():
    ...
    plot_rank_distribution([r[1] for r in ranks], 'pie_chart_most_similar_tags_on_training_data.png', 'Ranking of most similar tags on training data')

    test_ranks, _ = get_ranks(test_tagged)
    log.info('Plotting for principal ranks on test data')
    plot_rank_distribution([r[1] for r in test_ranks], 'pie_chart_most_similar_tags_on_test_data.png', 'Ranking of most similar tags on test data')
