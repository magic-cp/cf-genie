...
from cf_genie.embedders.doc2vec import (Doc2VecEmbedder30, Doc2VecEmbedder50,
                                        Doc2VecEmbedder100, Doc2VecEmbedder150,
                                        Doc2VecEmbedder200)
from cf_genie.embedders.fasttext import (FastTextEmbedder30,
                                         FastTextEmbedder50,
                                         FastTextEmbedder100,
                                         FastTextEmbedder150,
                                         FastTextEmbedder200)
